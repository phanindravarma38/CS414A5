...
import cs414.a4.phanisag.StartClient;
...
public class InUserGUI extends JPanel {
	...
	static {
		try {
			...
			System.setSecurityManager(StartClient.securityManager);
